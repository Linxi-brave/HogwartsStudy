...
from util.handle_json2 import get_value
...
def handle_result_sql(handlesql):
    if "sql" in handlesql:
        sql = handlesql.split(">")[1]
        return sql
...
if __name__ == "__main__":
    ...
    # print(handle_result('/api/v5/login/mplogin',"200"))
    # print(handle_result('/api/v5/login/mplogin',"101005"))
    print(handle_result_sql("sql>select * from tbuser"))
